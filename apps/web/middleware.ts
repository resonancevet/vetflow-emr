...
export const config = {
  matcher: [
    "/((?!login|register|legal|api/auth|_next|favicon.ico|favicon.svg|logo.svg|manifest.webmanifest|sw.js|api/trpc|portal|api-docs|api/portal|api/webhooks|api/cron|api/integrations).*)",
  ],
};
