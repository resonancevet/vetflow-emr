...
const installSteps = [
  {
    ...
    code: "git clone https://github.com/gettalky/openpims.git && cd openpims",
          ...
          {activeTab === "cloud" && (
            <div className="space-y-8">
              <div className="rounded-2xl border border-gray-200 bg-white p-8 sm:p-10 text-center">
                ...
                <a
                  href="https://vercel.com/new/clone?repository-url=https://github.com/gettalky/openpims"
                  target="_blank"
      ...
      <section className="py-16 sm:py-20 bg-gray-50 border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-sm text-gray-500">
            Still stuck?{" "}
            <a
              href="https://github.com/gettalky/openpims/issues"
              target="_blank"
              rel="noopener noreferrer"
